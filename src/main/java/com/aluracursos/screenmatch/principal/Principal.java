...
public class Principal {
    ...
    private final String API_KEY = "&apikey=5f249f5f";
    ...
    public void muestraElMenu() {
        ...
        while (opcion != 0) {
            var menu = """
                    ...
                    8 - Buscar epidsodios por titulo
            ...
            switch (opcion) {
                ...
                case 6:
                    ...
                    break;
                case 7: buscarPorMaximoDeTemporadasEvaluacion();
                    break;
                case 8:
...
//        DatosSerie datosSerie = getDatosSerie(); Trae los datos de las series que estan en la API
        mostrarSeriesBuscadas();
    ...
    private void buscarSeriesPorCategoria(){
        System.out.println("Escriba el genero de la serie que deseas buscar");
...
//        List<Serie> seriesPorTemporadasEvaluacion = repository.findByTotalTemporadasGreaterThanAndEvaluacionGreaterThan(Integer.valueOf(maximoTemporadas), evaluacionMinima);
    ...
    private void buscarTop5Episodios(){
        ...
        if(serieBuscada.isPresent()){
            ...
            System.out.println("Top 5 Episodios de " + serie.getTitulo());
